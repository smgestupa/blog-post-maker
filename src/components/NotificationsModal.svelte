...
<!--    .modal-warning {-->
<!--        @apply flex items-center bg-red-200 p-2 w-full rounded-md shadow-xl mx-auto-->
<!--        md:w-6/12;-->
<!--        margin-top: 2.5vh;-->
<!--    }-->
...
<!--            &lt;!&ndash; NOTIFICATION MODAL ICON &ndash;&gt;-->
...
<!--            </div>-->
<!--            &lt;!&ndash; /NOTIFICATION MODAL ICON &ndash;&gt;-->
<!--            &lt;!&ndash; NOTIFICATION MODAL MESSAGE &ndash;&gt;-->
<!--            <div class="{ $notifType === 'warning' ? 'modal-messages-warning' : 'modal-messages-success' }">-->
<!--                &lt;!&ndash; NOTIFICATION MODAL TITLE &ndash;&gt;-->
